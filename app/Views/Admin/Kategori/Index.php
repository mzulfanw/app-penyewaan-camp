        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url()  ?>/admin/kategori/add" class="btn btn-primary btn-sm float-end">Tambah</a>
                </div>
                <div class="card-body">
                            ...
                            foreach ($kategori as $k) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <a href="<?= base_url('admin/kategori/delete/' . $k['id'])  ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ?')" class="btn btn-danger btn-sm">
                                            ...
                                            <div class="col">
                                                <a href="<?= base_url('admin/kategori/edit/' . $k['id']) ?>" class="btn btn-warning btn-sm">
                                                    <dt class="the-icon"><svg class="svg-inline--fa fa-pen fa-w-16 fa-fw select-all text-white" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
